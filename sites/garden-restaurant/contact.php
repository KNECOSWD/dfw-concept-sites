...
<head>
  ...
  <title>Contact | Garden Restaurant</title>
  <meta name="description" content="Contact Garden Restaurant.">
...
<body class="theme-dark-header">
  ...
  <main id="main">
    <section class="page-hero">
      <div class="wrap">
        <h1>Contact</h1>
        <p class="lede">Call, email, or send a message.</p>
      </div>
    </section>
    <section>
      <div class="wrap contact-grid">
        <div class="prose">
          <p>Email gardenrestaurant@zing.com. Reservations and catering inquiries are listed on the live contact form. Order pickup or delivery on the restaurant’s published ordering page.</p>
          <p><strong>Phone:</strong> <a href="tel:+19724878289">(972) 487-8289</a></p>
          <p><strong>Email:</strong> <a href="mailto:gardenrestaurant@zing.com">gardenrestaurant@zing.com</a></p>
          <p><strong>Location:</strong> 3555 W Walnut St, Garland, TX 75042</p>
          <p><strong>Hours:</strong> Daily 10:00 AM–10:00 PM</p>
        </div>
                <form class="card form" id="contact-form" novalidate>
          <p>Send a message and follow up by phone so nothing is missed.</p>
          ...
          <p class="form-status" id="form-status" role="status" tabindex="-1">Thank you. This page does not send messages automatically — please call or email so the office receives your request.</p>
        </form>
      </div>
    </section>
  </main>
